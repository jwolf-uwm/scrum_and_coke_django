...
class TestInstructor(TestCase):
    ...
    def test_change_password(self):
        self.Instructor1 = Instructor("Supervisor1@uwm.edu", "DEFAULT_PASSWORD", "DEFAULT")
    ...
    def test_change_email(self):
        self.Instructor1 = Instructor("Intructor1@uwm.edu", "DEFAULT_PASSWORD", "DEFAULT")
        self.person2 = Person("goober@uwm.edu", "DEFAULT_PASSWORD", "DEFAULT")
        self.Instructor1.change_email("snoop@uwm.edu")
        model_person1 = models.ModelPerson.objects.get(email=self.Instructor1.email)
        self.assertEquals(model_person1.email, "snoop@uwm.edu")
        self.assertEquals(self.Instructor1.email, "snoop@uwm.edu")
        self.assertNotEquals(self.Instructor1.email, "Instructor1@uwm.edu")
        self.assertFalse(self.Instructor1.change_email("snoop@gmail.com"))
        self.assertFalse(self.Instructor1.change_email("no_at_symbol_or_dot_something"))
        self.assertFalse(self.Instructor1.change_email("goober@uwm.edu"))

    def test_change_phone(self):
        self.Instructor1 = Instructor("Instructor1@uwm.edu", "DEFAULT_PASSWORD", "DEFAULT")
